...
/**
 * WebPay enrolment plugin - support for user self unenrolment.
 *
...
$instance = $DB->get_record('enrol', array('id'=>$enrolid, 'enrol'=>'webpay'), '*', MUST_EXIST);
...
$PAGE->set_url('/enrol/webpay/unenrolself.php', array('enrolid'=>$instance->id));
...
$message = get_string('unenrolselfconfirm', 'enrol_webpay', format_string($course->fullname));
